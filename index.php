...
<body>
	...
	<nav class="navbar navbar-dark bg-secondary">
	  <a class="navbar-brand" href="index.php" style="color: #fff; float: right;">
	    Praktikum Pemrograman Web
	  </a>
	</nav>

	<div class="" style="margin-left: 0px;">
		<h2 align="center" style="margin: 30px; font-style: italic; font-variant: small-caps;">Tugas Minggu 4</h2>
